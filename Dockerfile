...
RUN apt-get install -y ros-melodic-rplidar-ros ros-melodic-robot-localization ros-melodic-rosserial ros-melodic-rosserial-arduino ros-melodic-rgbd-launch ros-melodic-map-server ros-melodic-amcl ros-melodic-nmea-navsat-driver
